...
wipe-ycsb-db:
	mongo --tls --tlsCAFile ../root-ca.pem --tlsCertificateKeyFile ../mongos-1-svc.pem --authenticationDatabase '$external' --authenticationMechanism='MONGODB-X509' mongos-1-svc:27017 --eval 'use ycsb; db.dropDatabase();'
