...
libraryDependencies += "org.apache.logging.log4j" % "log4j-core" % "2.25.3"
libraryDependencies += "org.apache.logging.log4j" % "log4j-api" % "2.25.3"
libraryDependencies += "org.apache.logging.log4j" % "log4j-slf4j2-impl" % "2.25.3"
