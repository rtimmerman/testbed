...
data:
  ...
  add-user.js: |
    ...
    outcome = db.runCommand(
      {
        createUser: "CN=config-server-svc-1,OU=School of Computing and Mathematical Sciences,O="Birkbeck, University of London",ST=Essex,C=GB,EMAIL=rtimme01@bbk.ac.uk",
        roles: [
    ...
    outcome = db.runCommand(
      {
        createUser: "CN=mongos-1-svc,OU=School of Computing and Mathematical Sciences,O="Birkbeck, University of London",ST=Essex,C=GB,EMAIL=rtimme01@bbk.ac.uk",
        roles: [
